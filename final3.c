...
void AdaGrad(int n,const float *o,float *h,float *A){
...
int main(void)
{
    ...
    for(int i=0;i<epoch;i++){
        ...
        for(int j=0;j<train_count/batch_size;j++){
            ...
            scale(784*50,(float)(1/batch_size),dEdA1_ave);
            scale(50,(float)(1/batch_size),dEdb1_ave);
            scale(50*100,(float)(1/batch_size),dEdA2_ave);
            scale(100,(float)(1/batch_size),dEdb2_ave);
            scale(100*10,(float)(1/batch_size),dEdA3_ave);
            scale(10,(float)(1/batch_size),dEdb3_ave);

            AdaGrad(784*50,dEdA1_ave,hA1,A1);
            AdaGrad(50,dEdb1_ave,hb1,b1);
            AdaGrad(50*100,dEdA2_ave,hA2,A2);
            AdaGrad(100,dEdb2_ave,hb2,b2);
            AdaGrad(100*10,dEdA3_ave,hA3,A3);
            AdaGrad(10,dEdb3_ave,hb3,b3);
